...
public class CarroController {
    ...
    @GetMapping(path = "/modelo/{nome}")
    public ResponseEntity<List<Carro>> findAllThatConatinsName(@PathVariable String nome) {
        List<Carro> carros = carroService.findAllThatConatinsName(nome);
